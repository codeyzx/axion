...
function NavbarFeed() {
  ...
  return (
    <nav className="flex 2xl:max-w-7xl 2xl:mx-auto 2xl:px-0 items-center justify-between bg-white z-[49] py-3 px-3 md:px-6 lg:px-16 border-b-gray-200 sticky top-0 border-b-[1px]">
      ...
      <div className="flex w-8/12 my-2">
        <input
          type="text"
          placeholder="Search Auction"
          className="w-full focus:border-purple-600 text-sm outline-none border-[1px] border-gray-300 transition-all duration-300 ease-out  rounded p-2 rounded-xl"
        />
      </div>
