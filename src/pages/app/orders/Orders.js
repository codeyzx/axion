    ...
    () => [
      {
        ...
        Cell: ({ cell: { value } }) => (
          <>
            <p
              className={`text-sm sm:hidden font-medium truncate text-gray-600`}
            >
              {value.substring(9, 14)}...
            </p>
            <p
              className={`text-sm hidden sm:inline font-medium truncate text-gray-600`}
            >
